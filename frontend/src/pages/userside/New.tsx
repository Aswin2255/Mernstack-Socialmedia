            ...
            <div>
                ...
                <div className="flex flex-col space-y-16">
                  ...
                  <div class="flex flex-col space-y-5">
                    <div>
                      <button onClick={handelsubmit} class="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 bg-socialblue border-none text-white text-sm shadow-sm">
                        Verify Account
                      </button>
                    </div>
                  </div>

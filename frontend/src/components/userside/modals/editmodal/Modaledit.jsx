...
function Modaledit({ closemodal, postdata, loader }) {
  ...
  const updatepost = async (postid) => {
    try {
      ...
      const { data } = await axios.patch(`/post/updatepost/${postid}`, formdata, {
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              {!imgremove ? (
                <div className="relative p-6 flex-auto">
                  ...
                  <div className="rounded-md overflow-hidden h-48 flex items-center shadow-md">
                    ...
                    ) : postdata[0].picturepath ? (
                      <img src={`/assets/${postdata[0].picturepath}`}></img>
                    ) : (
                      <h1>choose any editimage to dispaly</h1>
                    )}
                  </div>
                ...
                <h1 className="text-center">editimage is removed</h1>
              ) : (
                ''
              )}
              ...
              <div className="flex items-center justify-between p-6 border-t border-solid border-slate-200 rounded-b">
                ...
                <div>
                  ...
                  <button
                    disabled={!caption && !editimage ? true : false}
                    className={
                      caption || editimage
